...
void GameCanvas::setup() {
	...
	postprocessmanager.addEffect(new gChromaticAberration());
	postprocessmanager.addEffect(new gDynamicGrain(0.15f));
	postprocessmanager.addEffect(new gVignette(0.8, 0.2));
}
