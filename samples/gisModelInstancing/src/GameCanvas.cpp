...
void GameCanvas::setup() {
    ...
    model.loadModel("models/tree.obj");

	// Store one transform for each model instance.
	...
	for (int z = 0; z < 20; ++z) {
		for (int x = 0; x < 20; ++x) {
			...
			// Place the models in a 20x20 grid.
			transformation = glm::translate(transformation,glm::vec3((x - 10) * 4.0f, 0.0f, -z * 4.0f));
...
void GameCanvas::draw() {
    ...
    // Draw all models using one instanced draw call.
