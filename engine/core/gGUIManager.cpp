...
void gGUIManager::resetTheme(int guiTheme) {
	...
	gBaseGUIObject::setFont(&themefonts[FONT_FREESANS][FONT_REGULAR]);
...
void gGUIManager::loadThemes() {
	...
	themefonts[FONT_FREESANS][FONT_REGULAR].loadFont("FreeSans.ttf", 11);
	themefonts[FONT_FREESANS][FONT_BOLD].loadFont("FreeSansBold.ttf", 11);
	themefonts[FONT_FREESANS][FONT_ITALIC].loadFont("FreeSansOblique.ttf", 11);
	themefonts[FONT_FREESANS][FONT_BOLDITALIC].loadFont("FreeSansBoldOblique.ttf", 11);
