...
public:
	...
	gMesh();
	gMesh(std::vector<gVertex> vertices, std::vector<Index> indices, std::vector<gTexture> textures);
	virtual ~gMesh();

	void setVertices(std::vector<gVertex> vertices, std::vector<Index> indices = std::vector<Index>());
